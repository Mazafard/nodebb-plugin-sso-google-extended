	...
	<div class="row m-0">
		<div id="spy-container" class="col-12 px-0 mb-4" tabindex="0">
					...
					<div class="d-flex align-items-center gap-3">
						...
						<div>
							<h4 class="fw-bold mb-1 d-flex align-items-center gap-2 text-body">
								[[sso-google-extended:admin.header.title]]
								<span class="badge bg-primary-subtle text-primary border border-primary-subtle rounded-pill small">v{version}</span>
							</h4>
							<p class="text-muted mb-0 text-sm">[[sso-google-extended:admin.header.description]]</p>
						</div>
					</div>
					<div>
						<span id="sso-status-badge" class="badge bg-secondary-subtle text-secondary border border-secondary-subtle px-3 py-2 rounded-pill small">
							<i class="fa fa-circle me-1 small"></i> [[sso-google-extended:admin.status.checking]]
						</span>
					</div>
				</div>
			</div>
			...
			<div class="card shadow-sm border-0 rounded-4 p-3 p-md-4 mb-4">
				<h6 class="fw-semibold mb-2 text-body"><i class="fa fa-link text-primary me-2"></i> [[sso-google-extended:admin.redirect.title]]</h6>
				<p class="text-muted text-xs mb-3">[[sso-google-extended:admin.redirect.lead]]</p>
				...
				<div class="input-group mb-3">
					...
					<button class="btn btn-outline-primary text-sm" type="button" id="copyCallbackBtn">
						<i class="fa fa-copy me-1"></i> [[sso-google-extended:admin.redirect.copy]]
					</button>
				</div>
					...
					<div class="accordion-item border rounded-3 overflow-hidden">
						<h2 class="accordion-header">
							<button class="accordion-button collapsed bg-body-tertiary text-sm fw-semibold py-2.5" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSetupGuide" aria-expanded="false" aria-controls="collapseSetupGuide">
								<i class="fa fa-info-circle me-2 text-info"></i> [[sso-google-extended:admin.guide.title]]
							</button>
						</h2>
						<div id="collapseSetupGuide" class="accordion-collapse collapse" data-bs-parent="#setupAccordion">
							<div class="accordion-body text-xs text-muted py-3">
								<ol class="mb-0 ps-3">
									<li class="mb-2">[[sso-google-extended:admin.guide.step1]]</li>
									<li class="mb-2">[[sso-google-extended:admin.guide.step2]]</li>
									<li class="mb-2">[[sso-google-extended:admin.guide.step3]]</li>
									<li class="mb-2">[[sso-google-extended:admin.guide.step4]]</li>
									<li class="mb-2">[[sso-google-extended:admin.guide.step5]]</li>
									<li>[[sso-google-extended:admin.guide.step6]]</li>
								</ol>
							</div>
						</div>
					</div>
			...
			<form role="form" class="sso-google-settings">
				...
				<div class="card shadow-sm border-0 rounded-4 p-3 p-md-4 mb-4">
					<div class="d-flex align-items-center justify-content-between mb-3">
						<h6 class="fw-semibold mb-0 text-body"><i class="fa fa-shield-halved text-success me-2"></i> [[sso-google-extended:admin.credentials.title]]</h6>
						<span class="badge bg-success-subtle text-success border border-success-subtle rounded-pill text-xs">[[sso-google-extended:admin.credentials.encrypted]]</span>
					</div>
					<div class="mb-3">
						<label class="form-label small fw-semibold text-secondary-emphasis" for="app_id">[[sso-google-extended:admin.credentials.client_id]]</label>
						...
						<div class="form-text text-xs text-muted">[[sso-google-extended:admin.credentials.client_id_help]]</div>
					</div>
					<div class="mb-2">
						<label class="form-label small fw-semibold text-secondary-emphasis" for="secret">[[sso-google-extended:admin.credentials.client_secret]]</label>
						...
						<div class="form-text text-xs text-muted">[[sso-google-extended:admin.credentials.client_secret_help]]</div>
					</div>
				</div>

				<!-- Layout & UX Placement Card -->
				<div class="card shadow-sm border-0 rounded-4 p-3 p-md-4 mb-4">
					<h6 class="fw-semibold mb-1 text-body"><i class="fa fa-sliders text-primary me-2"></i> [[sso-google-extended:admin.layout.title]]</h6>
					<p class="text-muted text-xs mb-3">[[sso-google-extended:admin.layout.lead]]</p>

					<div class="row g-4 mb-2">
						<div class="col-lg-7">
							<div class="mb-3">
								<label class="form-label small fw-semibold text-secondary-emphasis" for="buttonPosition">[[sso-google-extended:admin.layout.placement]]</label>
								<select class="form-select text-sm" name="buttonPosition" id="buttonPosition">
									<option value="top">[[sso-google-extended:admin.layout.placement_top]]</option>
									<option value="before">[[sso-google-extended:admin.layout.placement_before]]</option>
									<option value="after">[[sso-google-extended:admin.layout.placement_after]]</option>
								</select>
								<div class="form-text text-xs text-muted">[[sso-google-extended:admin.layout.placement_help]]</div>
							</div>

							<div class="row g-3 mb-3">
								<div class="col-md-6">
									<label class="form-label small fw-semibold text-secondary-emphasis" for="buttonStyle">[[sso-google-extended:admin.layout.style]]</label>
									<select class="form-select text-sm" name="buttonStyle" id="buttonStyle">
										<option value="google-brand">[[sso-google-extended:admin.layout.style_google]]</option>
										<option value="standard">[[sso-google-extended:admin.layout.style_standard]]</option>
									</select>
								</div>
								<div class="col-md-6">
									<label class="form-label small fw-semibold text-secondary-emphasis" for="buttonLabel">[[sso-google-extended:admin.layout.label]]</label>
									<select class="form-select text-sm" name="buttonLabel" id="buttonLabel">
										<option value="Continue with Google">[[sso-google-extended:admin.layout.label_continue]]</option>
										<option value="Sign in with Google">[[sso-google-extended:admin.layout.label_signin]]</option>
									</select>
								</div>
							</div>
							...
							<div class="alert alert-info-subtle border border-info-subtle rounded-3 p-2.5 mb-3 text-xs d-flex align-items-start gap-2">
								...
								<div class="text-body-secondary">[[sso-google-extended:admin.layout.preview_tip]]</div>
							</div>
							...
							<div class="form-check form-switch mb-2">
								...
								<label for="hideAltLogins" class="form-check-label text-sm fw-semibold text-body">
									[[sso-google-extended:admin.layout.hide_alt]]
								</label>
								<div class="form-text text-xs text-muted">[[sso-google-extended:admin.layout.hide_alt_help]]</div>
							</div>
							...
							<div class="form-check form-switch mb-1">
								...
								<label for="applyRegister" class="form-check-label text-sm fw-semibold text-body">
									[[sso-google-extended:admin.layout.apply_register]]
								</label>
							</div>
						</div>
							...
							<div class="border rounded-4 p-3 bg-body-tertiary h-100 d-flex flex-column justify-content-center">
								<div class="text-center mb-2">
									<span class="badge bg-body-secondary text-secondary-emphasis rounded-pill px-3 py-1 text-xs">
										<i class="fa fa-eye me-1"></i> [[sso-google-extended:admin.preview.badge]]
									</span>
								</div>
								<div id="preview-layout-container" class="p-3 bg-body rounded-3 shadow-sm border d-flex flex-column gap-2">
									<div id="preview-google-btn" class="sso-google-btn-primary google-brand text-center justify-content-center d-flex align-items-center gap-2" style="min-height: 40px; padding: 0.5rem 1rem;">
										...
										<span id="preview-google-text" class="fw-semibold text-sm">[[sso-google-extended:button.continue_with_google]]</span>
									</div>
									<div id="preview-divider" class="sso-google-divider my-1 text-xs">
										<span>[[sso-google-extended:divider.or]]</span>
									</div>
								...
								<div class="text-center mt-2">
									<span id="preview-status-pill" class="badge bg-primary-subtle text-primary border border-primary-subtle rounded-pill text-xs">
										[[sso-google-extended:admin.layout.placement_top]]
									</span>
								</div>
							</div>
						</div>
				...
				<div class="card shadow-sm border-0 rounded-4 p-3 p-md-4 mb-4">
					<h6 class="fw-semibold mb-3 text-body"><i class="fa fa-user-check text-warning me-2"></i> [[sso-google-extended:admin.policies.title]]</h6>
					<div class="form-check form-switch mb-3">
						...
						<label for="autoconfirm" class="form-check-label text-sm fw-semibold text-body">
							[[sso-google-extended:admin.policies.autoconfirm]]
						</label>
						<div class="form-text text-xs text-muted">[[sso-google-extended:admin.policies.autoconfirm_help]]</div>
					</div>
					<div class="form-check form-switch">
						...
						<label for="disableRegistration" class="form-check-label text-sm fw-semibold text-body">
							[[sso-google-extended:admin.policies.disable_registration]]
						</label>
						<div class="form-text text-xs text-muted">[[sso-google-extended:admin.policies.disable_registration_help]]</div>
					</div>
				</div>
			</form>
		</div>
